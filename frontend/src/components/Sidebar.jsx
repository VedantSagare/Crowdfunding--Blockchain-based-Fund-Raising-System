...
const Icon = ({ styles, name, imgUrl, isActive, disabled, handleClick }) => (
    ...
    >
        <img
            src={imgUrl}
            alt="icon"
            className={`w-[45%] h-[45%] transition-all duration-300 ${isActive !== name && 'grayscale opacity-60 hover:opacity-100'}`}
        />
    </div>
)
...
const Sidebar = () => {
    ...
    return (
        <div className="flex justify-between items-center flex-col sticky top-5 h-[93vh] animate-slideDown">
            {/* Logo */}
            <Link to="/">
                <div className="w-[44px] h-[44px] rounded-[14px] bg-gradient-to-br from-[#667eea] to-[#764ba2] flex items-center justify-center hover:shadow-[0_0_30px_rgba(102,126,234,0.5)] transition-all duration-300 hover:scale-110 active:scale-95">
            ...
            {/* Navigation */}
            <div className="flex-1 flex flex-col justify-between items-center glass-effect rounded-[24px] w-[68px] py-6 mt-12">
                ...
                <div className="glass-effect w-[40px] h-[40px] rounded-[10px] flex justify-center items-center cursor-pointer hover:bg-[#2a2a35] transition-all duration-300 hover:scale-110 active:scale-95">
